...
public class EpilogueGenerator {
    ...
    public EpilogueGenerator(ProcessingEnvironment processingEnv, Map<TypeMirror, DeclaredType> customLoggers) {
    ...
    public void writeEpilogueFile(List<String> loggerClassNames, Collection<TypeElement> mainRobotClasses) {
        try {
            var centralStore = m_processingEnv.getFiler().createSourceFile("edu.wpi.first.epilogue.Epilogue");
