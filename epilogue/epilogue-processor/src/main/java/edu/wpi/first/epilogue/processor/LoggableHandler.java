...
public class LoggableHandler extends ElementHandler {
    ...
    public boolean isLoggable(Element element) {
        ...
        return (
            dataType.getAnnotation(Logged.class) != null ||
            (dataType instanceof DeclaredType decl && decl.asElement().getAnnotation(Logged.class) != null)
        );
    }
    ...
    public String logInvocation(Element element) {
        ...
        var reflectedType = m_processingEnv
            .getElementUtils()
