...
public class ChoreoTrajectory {
    ...
    /**
     * Returns the array of samples corresponding to the trajectory.
     *
     * @return the array of samples corresponding to the trajectory.
     */
    public ChoreoTrajectoryState[] getStates() {
        return samples.stream().toArray(ChoreoTrajectoryState[]::new);
    }
