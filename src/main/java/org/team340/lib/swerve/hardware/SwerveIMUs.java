...
import org.team340.lib.util.PhoenixUtil;
import org.team340.lib.util.ReduxUtil;
...
public final class SwerveIMUs {
    ...
    private static SwerveIMU simulate(SwerveIMU imu, SwerveConfig config, IMUSimHook simHook) {
        ...
        simHook.accept(speeds -> {
            yaw.value = yaw.value.plus(Rotation2d.fromRadians(speeds.omegaRadiansPerSecond * config.period));
        });
