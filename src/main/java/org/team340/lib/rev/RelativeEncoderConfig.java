...
public class RelativeEncoderConfig extends RevConfigBase<RelativeEncoder> {
    ...
    public void apply(CANSparkMax sparkMax, RelativeEncoder relativeEncoder) {
        applySteps(relativeEncoder, "Spark Max (ID " + sparkMax.getDeviceId() + ") Relative Encoder");
    }
    ...
    public void apply(CANSparkFlex sparkFlex, RelativeEncoder relativeEncoder) {
        applySteps(relativeEncoder, "Spark Flex (ID " + sparkFlex.getDeviceId() + ") Relative Encoder");
    }
